...
export default class Create extends Component {
    ...
    onSubmit(e){
        ...
        const novoAluno = {nome:this.state.nome, 
                               curso:this.state.curso,
                               IRA:this.state.IRA}

        axios.post('http://localhost:3002/alunos/register',novoAluno) //express
        .then(
            (res)=>{
                console.log('Aluno '+res.data._id+' inserido com sucesso.')    
            }
        )
        .catch(
            (error)=>{
